...
## Summary
- 1870 nodes · 4247 edges · 122 communities (75 shown, 47 thin omitted)
...
### Community 4 - "test_task_service.py"
Cohesion: 0.14
Nodes (8): _count_high_priority_for_date(), _effective_date(), _get_high_priority_limit(), date, Unit tests for task_service.py — no database required., TestCountHighPriorityForDate, TestEffectiveDate, TestGetHighPriorityLimit
...
### Community 7 - "TaskCard.tsx"
Cohesion: 0.09
Nodes (25): UI Naming Change: Type → Tags, Narrow Label.category Union / Remove Dead recurrence_group_id Type, Label, Task, CATEGORY_COLORS, LabelBadge(), LabelBadgeProps, DateFieldName (+17 more)

### Community 9 - "board_service.py"
Cohesion: 0.05
Nodes (48): CategoryEnum, Label, create_label(), delete_label(), list_labels(), delete, get, post (+40 more)

### Community 10 - "Task"
Cohesion: 0.06
Nodes (62): Base, Board, _sort_order_default(), StateEnum, Task, TaskLabel, UserSettings, _owned_board_id() (+54 more)

### Community 11 - "tasks.py"
Cohesion: 0.07
Nodes (41): complete_task(), create_task(), delete_task(), get_task(), list_tasks(), date, delete, get (+33 more)

### Community 12 - "TaskForm.tsx"
Cohesion: 0.19
...
Cohesion: 0.11
Nodes (23): PLAN: Rename Reports → Archive, add date-range presets and board filtering, BoardCompletions, CompletionRecord, CompletionsReport, getCompletions(), GetCompletionsOptions, ArchiveBoardGroups(), ArchiveBoardGroupsProps (+15 more)
...
### Community 18 - "useBoard"
Cohesion: 0.23
Nodes (11): Board Color Everywhere (TaskCard/BoardTabs accents), Plan: Custom board order + board-color styling + alphabetical tags, PLAN-feat-multi-board-backend (PR #33, external, merged), BoardContext + BoardSwitcher UI Design, PLAN: feat-multi-board-frontend (PR 2/3), ArchiveBoardTabs(), frontend/src/components/BoardSwitcher.tsx, BoardTabs() (+3 more)
...
Cohesion: 0.09
Nodes (37): Board-Grouped Collapsible Rendering (mirrors Today view), PLAN: feat-board-collapse-mobile — Collapsible boards (mobile), BoardCollapseContext (modeled on FilterContext), PLAN: feat-board-collapse-web — Collapsible boards (web), Plan: feat-focused-view-web (PR 2 of 3), getDayViewTasks(), FocusedBoard, getFocusedViewTasks() (+29 more)
...
Cohesion: 0.13
Nodes (9): complete_task(), create_task(), Any, Label, Session, Task, _resolve_labels(), TestCreateTaskLinks (+1 more)
...
### Community 115 - "src/App.tsx"
Cohesion: 0.09
Nodes (29): Custom Board Order (sort_order, order-driven default board), tasks.sort_order Fractional-Index Precedent (PR #61), Native input[type=color] Auto-Save Picker (routes through setColorBoard), Board, createBoard(), deleteBoard(), getBoards(), updateBoard() (+21 more)
...
Cohesion: 0.13
Nodes (34): Development Plan: Enhance All View with Priority Collapse & Date Display, Monday Column (Friday-only) + Priority Split/Collapse, PriorityTier, DateFieldName, FocusedTaskCard(), LABEL_COLORS, DateFieldLine(), DateFieldName (+26 more)
