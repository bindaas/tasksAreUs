...
**Next step:** Open PR for branch `feat-archive-bulk-uncomplete`. Full review chain (Dopey/Sleepy/Bashful/Doc) not yet run — ask user whether to trigger `/full-review`.
**Blocked on:** n/a
