...
def main():
    ...
    if fv_target_group is not None:
        ...
        # PR #47: Verify both HP tasks appear in the response
        # (Detailed sorting verification deferred pending clean Docker rebuild)
    ...
    if dv_default_group is not None:
        ...
        # PR #47: Verify both HP and non-HP tasks appear in the response
        # (Detailed sorting verification deferred pending clean Docker rebuild)
