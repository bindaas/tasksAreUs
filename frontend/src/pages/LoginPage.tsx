  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 w-full max-w-sm">
        ...
        <p className="text-sm text-gray-500 mb-8">to continue to tasksAreUs</p>
          ...
          <div className="space-y-3">
            ...
            {showEmailForm ? (
              ...
              <button
                ...
                disabled={busy}
                className="w-full border border-gray-300 rounded-lg px-4 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
                Continue with email
              </button>
            )}
